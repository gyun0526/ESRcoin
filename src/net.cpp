...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ESRcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"esrcointools.com", "115.68.52.232"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"esrcointools.com", "testnet-seed.esrcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ESRcoin is probably already running."), addrBind.ToString().c_str());
        else
